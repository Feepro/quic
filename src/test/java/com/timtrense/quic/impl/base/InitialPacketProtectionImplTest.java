...
//        byte[] initialSecret = InitialPacketProtectionImpl.extractInitialSecret( clientConnectionId, drafted_version);
//        assertArrayEquals( new byte[]{
...
//        ippi.initialize( clientConnectionId, protocolVersion);
